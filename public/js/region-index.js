...
$(document).ready(function () {
    ...
    // Modals
    const modalShow = new bootstrap.Modal(document.getElementById('modalShowRegion'));
    const modalEdit = new bootstrap.Modal(document.getElementById('modalEditRegion'));

    loadDataTables().then(function () {
        console.log('✅ DataTables loaded successfully');

        // Initialize DataTables
        const table = $('#region-datatable').DataTable({
            processing: true,
            serverSide: true,
            ajax: {
                    ...
                    render: function (data, type, row) {
                        ...
                        <div class="action-icons">
                            ...
                            <button
                                ...
                                data-item-id="${row.id}"
                                data-item-name="${row.name || 'esta región'}"
                                title="Eliminar"
                            >
        ...
        // View Button Handler
        $('#region-datatable').on('click', '.btn-view', function () {
            ...
            fetch(`/${config.dominio}/region/${itemId}/details`)
                ...
                .then(data => {
                    ...
                    // Populate Modal
                    document.getElementById('showRegionName').value = data.name;
                    document.getElementById('showRegionStatus').value = data.status;
        ...
        // Edit Button Handler
        $('#region-datatable').on('click', '.btn-edit', function () {
            const itemId = $(this).data('item-id');
            ...
            fetch(`/${config.dominio}/region/${itemId}/details`)
                ...
                .then(data => {
                    ...
                    form.action = `/${config.dominio}/region/${itemId}/edit`;

                    document.getElementById('editRegionName').value = data.name;
        ...
        $('#region-datatable').on('click', '.action-icon-delete', function () {
            const itemId = $(this).data('item-id');
            ...
            Swal.fire({
                ...
                fetch(`/${config.dominio}/region/${itemId}/delete`, {
                    method: 'POST',
                    headers: {
